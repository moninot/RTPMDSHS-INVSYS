...
class Login:
    def __init__(self, root):
        ...
        self.lbl_title = Label(
            self.title_frame, text="RTPM-DSHS Login Form", bd=4, relief=RIDGE,  bg="AntiqueWhite1", fg="sienna4", font=("roboto sans-serif", 23), pady=14)
        ...
        self.fname_label = Label(self.form_frame, text='',
                                 font=('bold', 24), bg="AntiqueWhite1", fg="salmon3", padx=20, pady=7).grid(row=2, column=2, sticky=W)
        # Username
        self.username_text = StringVar()
        self.username_label = Label(self.form_frame, text='Username :',
                                    font=("roboto sans-serif", 14), bg="AntiqueWhite1", fg="salmon3", padx=5, pady=10).grid(
        ...
        self.password_label = Label(self.form_frame, text='Password :',
                                    font=("roboto sans-serif", 14), bg="AntiqueWhite1", fg="salmon3", padx=5, pady=14).grid(
        ...
        self.btn_frame = Frame(
            self.form_frame, bd=2, relief=RIDGE, bg="AntiqueWhite1")
        self.btn_frame.place(x=87, y=199, width=382, height=90)

        # Space Label para ma-move down
        self.space_lbl = Label(self.btn_frame, text='',
                               bg="AntiqueWhite1", padx=12).grid(row=2, column=0)

        # Buttons
        self.register_btn = Button(self.btn_frame, text='Login', width=15, height=2,  bd=2,
                                   relief=FLAT, bg="sienna4", fg="white", command=self.fields, font=("roboto sans-serif", 10, "bold"))
        self.register_btn.grid(row=2, column=1, padx=19, pady=23)

        self.back_btn = Button(self.btn_frame, text='Create Account', width=15, height=2,
                               bg="sienna4", fg="white", bd=2, relief=FLAT, command=self.register, font=("roboto sans-serif", 10, "bold"))
        ...
        if self.username_entry.get() == '' or self.password_entry.get() == '':
            ...
            try:
                ...
                if row == None:
                    ...
                    messagebox.showinfo(
                        'Success', 'Welcome to RTPM-DSHS Science Department Inventory')
                    self.clear()
                    self.root.destroy()
                    import dashboard
                con.close()
    ...
    def register(self):
        ...
        top = Toplevel()
        top.title("RTPM-DSHS Faculty Authorization Form")
        ...
        # Title Head
        top.lbl_title = Label(
            top, text="Authorization Form", bd=4, fg="salmon3", relief=RIDGE,  bg="AntiqueWhite1", font=("roboto sans-serif", 23), pady=7)
        ...
        top.fname_label = Label(top.title_frame, text='',
                                 font=('bold', 14), bg="AntiqueWhite1", fg="salmon3", padx=12, pady=20).grid(
                                     row=2, column=2, sticky=W)

        # Firstname
        fname_text = StringVar()
        top.fname_label = Label(top.title_frame, text='First Name :',
                                 font=("roboto sans-serif", 14), bg="AntiqueWhite1", fg="salmon3", padx=10, pady=20).grid(
        ...
        top.lname_label = Label(top.title_frame, text='Last Name :',
                                 font=("roboto sans-serif", 14), bg="AntiqueWhite1", fg="salmon3", padx=10).grid(
            row=3, column=3, sticky=W)
        ...
        top.space_lbl = Label(top.title_frame, text='',
                               font=('bold', 14), bg="AntiqueWhite1", fg="salmon3", padx=20).grid(
            row=8, column=2, sticky=W)

        # Frames para sa Buttons
        # Frames
        top.btn_frame = Frame(
            top.title_frame, bd=2, relief=RIDGE, bg="AntiqueWhite1")
        top.btn_frame.place(x=0, y=300, width=523, height=110)

        # Space Label para ma-move down
        top.space_lbl = Label(top.btn_frame, text='',
                               font=('bold', 14), bg="AntiqueWhite1", fg="salmon3", padx=32).grid(
            row=1, column=2, sticky=W)

        # Buttons
        top.register_btn = Button(top.btn_frame, text='Create Account', command=register_data, width=15, height=2,  bd=2,
                                   relief=FLAT, bg="sienna4", fg="white", font=("roboto sans-serif", 12, "bold"))
        top.register_btn.grid(row=2, column=3, padx=19)

        top.back_btn = Button(top.btn_frame, text='Back', width=15, height=2,
                               bg="sienna4", fg="white", bd=2, relief=FLAT, command=login_field, font=("roboto sans-serif", 12, "bold"))
